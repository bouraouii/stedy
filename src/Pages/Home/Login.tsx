...
import { cryptage} from "../../Constant/Cryptage";
...
export default function Login() {
  ...
  const handleSubmit = (e: any) => {
    ...
    if (formData.username === "test" && formData.password === "test") {
     ...
     // localStorage.setItem("login",cryptage(jsonString));

      localStorage.setItem("user",cryptage(formData.username));
      localStorage.setItem("password",cryptage(formData.password));


      dispatch(setAdmin({email:"test", Password:"test"}))
